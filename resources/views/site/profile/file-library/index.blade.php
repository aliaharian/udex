...
{{--                </div>--}}
                        ...
                        <li>
                            <a href="#">
                                <span class="row align-items-center">
                                    ...
                                    <span class="col-3 right"><span class="count">0</span><span class="icon-arrow-right-line"></span></span>
                                </span>
                            </a>
                        </li>
                    </ul>
                ...
                <div class="quick-access">
                    <div class="row">
                        <div class="col-4">
                            <a href="#" class="item-inner center">
                ...
                <div class="show-file">
                    ...
                    <div class="heading-nav">
                        <div class="row align-items-center">
                            <div class="col-9">
                                <div class="title-section">All files (1)</div>
                            </div>
                            <div class="col-3">
                        ...
                        <div class="item">
                            <div class="row align-items-center">
                                <div class="col-9">
                                    ...
                                    <div class="file-date">Sat, 8th May 2021</div>
                                </div>
                                <div class="col-3 right">
                                    <a href="#" class="view-file"><span class="icon-search"></span></a>
                                </div>
                            </div>
                        </div>
                    </div>
