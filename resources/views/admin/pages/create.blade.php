...
@section('content')
    <section class="form-section">
        {!! Form::open(['route'=>'pages.store', 'id'=>'form', 'enctype' => 'multipart/form-data']) !!}
        <div class="row">
            <div class="col-9">
                <div class="row">
                    {{-- Page Template --}}
                        ...
                        <div class="widget-block widget-item widget-style">
                            ...
                            <div class="widget-content widget-content-padding">
                                <div class="form-group row no-gutters g-0">
                                    ...
                                    @endif
                                    {!! Form::text('title',null,[ 'required', 'id'=>'title' , 'class'=>'col-12 field-style input-text', 'placeholder'=>'Enter the Page title']) !!}
                                ...
                                <div class="form-group">
                                    <div style="margin-bottom: 10px;">{!! Form::label('content_text','Page Content') !!}
                                        <span class="required">(Required)</span></div>
                                    <textarea class="field-style input-text" id="content_text" name="content_text" placeholder="Enter the Page content">{{ old('content_text') }}</textarea>
